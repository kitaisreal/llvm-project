...
; CHECK-NEXT:    [[CALL:%.*]] = call i32 @strcmp(ptr [[C:%.*]], ptr noundef @s0)
...
; CHECK-NEXT:    [[CALL:%.*]] = call i32 @strcmp(ptr noundef @s1, ptr [[C:%.*]])
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i32 [[CALL]], 0
; CHECK-NEXT:    ret i1 [[CMP]]
;
...
; CHECK-NEXT:    [[CALL:%.*]] = call i32 @strcmp(ptr noundef @s1, ptr noundef @s1)
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i32 [[CALL]], 0
; CHECK-NEXT:    ret i1 [[CMP]]
;
  %call = call i32 @strcmp(ptr noundef @s1, ptr noundef @s1)
  %cmp = icmp eq i32 %call, 0
  ret i1 %cmp
}
